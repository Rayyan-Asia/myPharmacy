...
import com.example.mypharmacy.ui.intro.IntroActivityListeners;
...
public class CreateFamilyMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_family_member_actvity);
        personRepository = new PersonRepositoryImpl(this);
        familyRepository = new FamilyRepositoryImpl(this);
        save = findViewById(R.id.member_save_button);
        firstNameField = findViewById(R.id.member_first_name_field);
        lastNameField = findViewById(R.id.member_last_name_field);
        genderSpinner = findViewById(R.id.member_gender_spinner);
        birthDayField = findViewById(R.id.member_birth_day_field);
        addressField = findViewById(R.id.member_address_field);
        phoneNumberField = findViewById(R.id.member_phone_number_field);
        weightField = findViewById(R.id.member_weight_field);
        heightField = findViewById(R.id.member_height_field);
        maritalStatusSpinner = findViewById(R.id.member_marital_status_spinner);
        bloodTypeSpinner = findViewById(R.id.member_blood_type_spinner);
        locationType = findViewById(R.id.member_pic_location_type);
    ...
    private void initListeners() {
        ...
        save.setOnClickListener(v -> {
            ...
            if (check == 0) {
                // get the image
                StorageType type =  (StorageType)locationType.getSelectedItem();
    ...
    private void saveImageToDatabase(String path) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                long id = personRepository.insertPerson(person);
                FamilyMember member = new FamilyMember();
                member.familyId = familyId;
                member.personId = (int) id;
